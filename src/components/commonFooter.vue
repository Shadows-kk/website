  ...
  <div class="relative z-10 pb-17.5 lg:pb-22.5 xl:pb-27.5">
    ...
    <div class="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0 relative pt-17.5">
      ...
      <div class="flex flex-wrap justify-between">
        <div class="mb-10 max-w-[571px] w-full text-lg color-grayText">
          <a href="/" class="mb-8.5 inline-block">
            <img src="@/assets/img/logo.png" alt="" />
          </a>
          <p class="mb-12 xl:w-4/5">
            Capix is designed to empower your project capabilities
          </p>
          <div class="flex items-center gap-5">
            <a
              href="https://twitter.com/dev_firdavs"
              class="color-grayText hover:text-white ease-in duration-300"
            >
              <svg
                class="fill-current"
                width="24"
            ...
            <a
              href="https://github.com/Firdavs-coder/Firdavs-coder"
              class="color-grayText hover:text-white ease-in duration-300"
            >
              <svg
                class="fill-current"
            ...
            <a
              href="https://www.linkedin.com/in/firdavscoder/"
              class="color-grayText hover:text-white ease-in duration-300"
            >
              <svg
                class="fill-current"
          ...
          <p class="font-medium mt-5.5">CAPIX.uz</p>
        </div>
        <div class="max-w-[571px] w-full text-lg color-grayText">
          <div class="flex flex-col sm:flex-row sm:justify-between gap-10">
            <div>
              ...
              <ul class="flex flex-col gap-3.5">
                <li>
                  <a
                    href="https://docs.capix.uz/apis/photolab.me-api"
                ...
                <li>
                  <a
                    href="https://docs.capix.uz/apis/toonme-api"
                    class="font-medium ease-in duration-300 hover:text-white"
                    >Toonme</a
                  >
                </li>
                <li>
                  <a
                    href="https://docs.capix.uz/apis/ai-picture-upscaler-api"
                    class="font-medium ease-in duration-300 hover:text-white"
                    >AI Image Upscaler</a
                  >
                </li>
                <li>
                  <a
                    href="https://docs.capix.uz/apis/ai-picture-colorizer-api"
                    class="font-medium ease-in duration-300 hover:text-white"
                    >AI Image Colorizer</a
                  >
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul class="flex flex-col gap-3.5">
                <li>
                  <a
                    href="https://docs.capix.uz/apis/ai-and-plagiarism-checker-api"
                    class="font-medium ease-in duration-300 hover:text-white"
                    >AI &amp; Plagiarism Checker</a
                  >
                </li>
                <li>
                  <a
                    href="https://docs.capix.uz/apis/ai-background-remover-api"
                    class="font-medium ease-in duration-300 hover:text-white"
                ...
                <li>
                  <a
                    href="https://docs.capix.uz/apis/home-gpt-api"
                    class="font-medium ease-in duration-300 hover:text-white"
                    >Home GPT</a
                  >
                </li>
                <li>
                  <a
                    href="https://docs.capix.uz/apis/tts-universal-api"
                    class="font-medium ease-in duration-300 hover:text-white"
                    >TTS Universal</a
                  >
                </li>
            ...
            <div>
              <h5 class="font-semibold text-white mb-5">Category</h5>
              <ul class="flex flex-col gap-3.5">
                <li>
                  <a
                    href="#support"
